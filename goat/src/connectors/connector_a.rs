...
impl ConnectorA {
    pub fn new(
        ...
        ConnectorA::new_with_timelock_config(
            network,
    ...
    pub fn new_with_timelock_config(
        ...
        ConnectorA::new_with_timelock(
            network,
            operator_taproot_public_key,
            n_of_n_taproot_public_key,
            timelock_config.connector_a,
        )
    }

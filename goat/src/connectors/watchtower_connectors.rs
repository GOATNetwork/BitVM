...
use crate::{
    assert_scripts::LabelHash,
    constants::{OPERATOR_ACK_TIMELOCK, WATCHTOWER_CHALLENGE_TIMELOCK},
...
impl AckConnector {
    pub fn new(
        ...
        AckConnector {
            ...
            ack_blocks_timelock: num_blocks_per_network(network, OPERATOR_ACK_TIMELOCK),
            hashlock,
        }
    }

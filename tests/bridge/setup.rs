...
use bitvm::bridge::{
    ...
    connectors::{
        connector_0::Connector0, connector_1::Connector1, connector_2::Connector2, connector_3::Connector3, connector_a::ConnectorA, connector_b::ConnectorB, connector_c::ConnectorC, connector_k::{self, ConnectorK}, connector_z::ConnectorZ
    },
    contexts::{
    ...
    graphs::base::{
        DEPOSITOR_SECRET, EVM_ADDRESS, N_OF_N_SECRET, OPERATOR_SECRET, WITHDRAWER_SECRET, OPERATOR_STATEMENT
    },
};

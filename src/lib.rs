...
use bitcoin::{hashes::Hash, hex::DisplayHex, Opcode, ScriptBuf, TapLeafHash, Transaction, Witness};
...
pub fn execute_witness_script(script: treepp::Script, witness: Witness) -> ExecuteInfo {
